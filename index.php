...
<head>
    ...
    <title>Учебник Python | Главная</title>
    <meta name="Description" content="Учебник Python - Ввод-вывод данных, переменные, типы данных, условный оператор, циклы, функции и модули." />
